"""
This is referred from https://github.com/locuslab/qpth/blob/master/qpth/solvers/cvxpy.py
"""
...
def forward_single_np(Q, p, G, h, A, b, sol_opt=cp.CVXOPT, verbose=False):
